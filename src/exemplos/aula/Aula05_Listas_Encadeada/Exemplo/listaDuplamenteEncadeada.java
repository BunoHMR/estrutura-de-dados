...
class DoublyLinkedList {
    ...
    // -------------------------------------------------------------
    public boolean insertAfter(final long key, final long dd) // insert dd just after key
    {                              // (assumes non-empty list)
        Link current = first;          // start at beginning
        while (current.dData != key)    // until match is found,
        {
            current = current.next;     // move to next link
            if (current == null) return false; // didn't find it
        }
        final Link newLink = new Link(dd);   // make new link
    ...
    // -------------------------------------------------------------
    public Link deleteKey(final long key)   // delete item w/ given key
    {                              // (assumes non-empty list)
        Link current = first;          // start at beginning
        while (current.dData != key)    // until match is found,
        {
...
class DoublyLinkedApp {
    public static void main(final String[] args) {                             // make a new list
        final DoublyLinkedList theList = new DoublyLinkedList();
